...
CU_OBJS = build/particles.cu.o build/ParticleSystem.cu.o build/CudaHelpers.cu.o  # CUDA Object files
...
build/ParticleSystem.cu.o: src/ParticleSystem.cu include/ParticleSystem.cuh
	$(NVCC) $(NVCCFLAGS) --device-c -c $< -o $@
